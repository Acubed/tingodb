...
function applySet(obj,$set,tdb) {
	...
	_.each($set, function (v,k) {
		...
		if (v && typeof v=='object' && !(v instanceof tdb.ObjectID || v instanceof Date || typeof v=='function' || v instanceof tdb.Code) ) {
			if (!t[k])
				t[k]={};
			applySet(t[k],v,tdb);
		}
...
tcoll.prototype.__find = function (query, fields, skip, limit, sort_, order, hint, arFields, cb) {
	...
	console.log('Matcher:', (arrayMatch?qt.native3():qt.native()));
