...
function stree(query,ctx) {
	...
	if (Array.isArray(query)) {
	...
	} else if (typeof query=='object' && !(query instanceof tdb.ObjectID || query instanceof Date || typeof query=='function' || query instanceof tdb.Code)) {
		_.each(query, function (v,k) {
			...
			if (op!=null) {
				...
				if (typeof v=='function' && !(v instanceof tdb.ObjectID || v instanceof Date || typeof query=='function' || query instanceof tdb.Code)) {
